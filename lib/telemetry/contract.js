...
//     sha256sum <sailkick>/shared/engine/signalk-map.js | cut -c1-12
//
// The app moved this file public/engine/ -> shared/engine/ in 8fd58cf. `git mv` preserved
// the content, so the pin below is unchanged and still matches — but both seam tests in
// test/telemetry.test.js started SKIPPING ("app source not checked out"), because the
