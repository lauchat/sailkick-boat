// VENDORED from sailkick/shared/engine/polar.js @ d54bfc1  sha256:a42f126ccdcfbbab
// Re-pinned after the app split its polar editing helpers out (HANDOFF-polar-split): the
// evaluator this copy uses is byte-identical, only the hash of the upstream FILE moved.
// Nothing failed at the time, which is why test/vendored.test.js now checks every header
// here against the app source — a pin nothing verifies is a comment, not a contract.
// NB: polarToCSV and blankPolar are deliberately not carried across; the boat evaluates
// polars, it does not author them.
